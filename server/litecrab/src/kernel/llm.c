...
#define LLM_WIRE_RESPONSE_MAX (2U * 1024U * 1024U)
#define LLM_HTTP_HEADER_MAX (32U * 1024U)
...
/* OpenSSL's stable public ABI declarations.  Keeping this small interface here
 * lets LiteCrab build on minimal WSL images that ship the runtime but not the
 * development headers. */
